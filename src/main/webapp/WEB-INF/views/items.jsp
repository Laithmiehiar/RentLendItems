				...
				<div class="col-lg-offset-2 col-lg-10">
					<p>
						<a href="<spring:url value="/item" />" class="btn btn-primary">
							...
							class="btn btn-primary"> Own Items </a>
						<c:set var="val" value="${role}" />
						<c:choose>
							<c:when test="${val == 'ROLE_ADMIN'}">
								<a href="<spring:url value="/user/listUser" />"
						...
						<div id="custom-search-input">
							...
							<div class="input-group col-md-12">
								<input style="width: 700px; height: 40px;" type="text"
									...
									class="btn btn-primary btnDesgined " type="submit"
									value="search" />
								</span>
							</div>
						</div>
