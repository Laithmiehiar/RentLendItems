...
<body>
	...
	<section class="container"> <form:form commandName="item"
		...
		<fieldset>
			...
			<div class="form-group">
				...
				<div class="col-lg-10">
					<form:input id="itemPrice" path="itemPrice" type="text"
						class="form:input-large" value="${item.itemPrice}"/>
			...
			<div class="form-group">
				...
				<div class="col-lg-offset-2 col-lg-10">
					<a href="<spring:url value="/item/ownItems" />" class="btn btn-primary">
						Back </a>
				</div>
